          ...
          appBar: AppBar(
            ...
            leading: FlutterFlowIconButton(
              ...
              icon: Icon(
                ...
                color: FlutterFlowTheme.of(context).colorFixNAV,
                size: 25.0,
              ),
              onPressed: () async {
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      if (_model.emailresetTextController.text
                                          .isEmpty) {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                          const SnackBar(
                                            content: Text(
                                              'Não foi identificado seu email, por favor informe para prossegui com a redefinição de senha.',
                                            ),
                                          ),
                                        );
                                        return;
